...
//		var/list/alljobs = get_all_jobs()
	...
	//don't strip organs
				...
				if(istype(M, /mob/living/carbon/human))
					...
					prisoner.equip_if_possible(new /obj/item/clothing/under/colors/orange(prisoner), prisoner.slot_w_uniform)
...
// Now isn't that much better? IT IS NOW A PROC, i.e. kinda like a big panel like unstable
	...
	//don't warp them if they aren't ready or are already there
						...
						if(!security)
							...
							H.equip_if_possible(new /obj/item/clothing/under/colors/orange(H), H.slot_w_uniform)
